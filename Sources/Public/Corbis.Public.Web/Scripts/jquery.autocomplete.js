...
(function ($) {
    ...
    Autocomplete.prototype = {
        ...
        initialize: function () {
            ...
            $('<div id="' + this.mainContainerId + '" style="position:absolute;z-index:9999;"><div class="autocomplete-w1"><div class="autocomplete" id="' + autocompleteElId + '" style="display:none; width:270px;"></div></div></div>').appendTo('body');
        ...
        fixPosition: function () {
            ...
            $('#' + this.mainContainerId).css({ top: (offset.top + this.el.innerHeight())+ 10 + 'px', left: offset.left + 'px' });
        },
